...
The whole code can be reproduce in three simple steps:
...
3. Run "results_graphics.py" to get the graphics of each experiment about (i) alpha t-value, (ii) Sharpe out-of-sample, (iii) R-squared.
